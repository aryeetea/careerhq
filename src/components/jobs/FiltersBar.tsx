...
export function FiltersBar({
  ...
  return (
    <div className="px-4 pb-4 pt-4 sm:px-8 lg:px-10">
      <div className="flex flex-wrap items-center gap-2 rounded-[1.5rem] border border-border/60 bg-card/40 p-2 shadow-soft">
