...
// Reached after AuthCallback verifies the recovery link from
// requestPasswordReset() and forwards here. Supabase puts a recovery session
// in the URL hash automatically; onAuthStateChange in AuthProvider picks it
// up, so by the time this form submits, updateUser() has a valid session to
// act on.
