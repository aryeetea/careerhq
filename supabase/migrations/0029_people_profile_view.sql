-- =====================================================================
-- Bloom — secure read-only people profile view.
--
-- Returns only baseline identity + fields the viewer is allowed to see
-- based on friendship, blocking, pending requests, selected-friend
-- visibility, and shared-group/shared-goal relationships. Private profile
-- columns never flow to the client for other users.
-- =====================================================================
